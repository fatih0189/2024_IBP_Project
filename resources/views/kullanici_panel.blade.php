...
<body>
  ...
  <div class="banner__overlay">
    <div class="banner__container">
      ...
      <p class="banner__text">Aktif Kullanıcı: {{Auth::user()->email}}</p>
      <a href="{{route('userReports')}}" class="btn btn--opacity">Son Duyurular</a>
      <br><br>
      <a href="{{route('userChat')}}" class="btn btn--opacity">İletişim</a>
    </div>
